...
book = my_library
book.add_title(" The Body Keeps the Score - Bessel van der Kolk")
book.add_title("Sapiens - Yuval Noah Harari")
book.add_title(" Braiding Sweetgrass - Robin Wall Kimmerer")
book.add_title("  The Warmth of Other Suns - Isabel Wilkerson")
